...
!!
      subroutine GFS_PBL_generic_pre_run (im, levs, nvdiff, ntrac, rtg_ozone_index,      &
        ...
        imp_physics_nssl2m, imp_physics_nssl2mccn, nssl_hail_on,                         &
...
!!
      ...
      integer, parameter  :: kp = kind_phys
      integer, intent(in) :: im, levs, nvdiff, ntrac, ntchs, ntchm, kdt, ntccn, nthl, nthnc, ntgv, nthv
      ...
      logical, intent(in) :: ltaerosol, nssl_hail_on, cplflx, cplchm, lssav, ldiag3d, lsidea
