...
!!
      subroutine GFS_PBL_generic_pre_run (im, levs, nvdiff, ntrac,                       &
        ...
        cplchm, ltaerosol, nssl_ccn_on, nssl_hail_on,                          &
      ...
      logical, intent(in) :: cplchm, ltaerosol, nssl_ccn_on, nssl_hail_on, hybedmf, do_shoc, satmedmf
...
!!
      subroutine GFS_PBL_generic_post_run (im, levs, nvdiff, ntrac,                                                            &
        ...
        imp_physics_fer_hires, imp_physics_nssl, ltaerosol, nssl_ccn_on, nssl_hail_on,                                         &
         cplflx, cplchm, lssav, flag_for_pbl_generic_tend, ldiag3d, qdiag3d, lsidea, hybedmf, do_shoc, satmedmf,               &
      ...
      integer, intent(in) :: imp_physics, imp_physics_gfdl, imp_physics_thompson, imp_physics_wsm6
      integer, intent(in) :: imp_physics_zhao_carr, imp_physics_mg, imp_physics_fer_hires, imp_physics_nssl
      logical, intent(in) :: ltaerosol,nssl_ccn_on, nssl_hail_on, cplflx, cplchm, lssav, ldiag3d, qdiag3d, lsidea
